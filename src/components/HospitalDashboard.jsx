...
export default function HospitalDashboard() {
  ...
  const fetchLatestAlert = useCallback(async () => {
    try {
      ...
      const latestAlert = data.alert || null;
  ...
  const acknowledgeAlert = async () => {
    ...
    try {
      ...
      const res = await fetch(`${BASE_URL}/alerts/${alertData.id}/acknowledge`, {
        ...
        body: JSON.stringify({
          acknowledged_by: user?.organization_name || "Hospital Team",
        }),
      });
  ...
  return (
    <div className="hospital-page">
        ...
        <div className="hospital-header-top">
          <div>
            <h1 className="hospital-title">
              {user?.organization_name || "Hospital Dashboard"}
            </h1>
            <p className="hospital-subtitle">
              {user?.city || "Hospital Emergency Service"}
            </p>
          </div>

          <button onClick={handleLogout} className="hospital-logout-btn">
            Logout
          </button>
        </div>
      </div>
      ...
      <div className="hospital-content">
        {loading ? (
          <div className="hospital-info-card">Loading latest alert...</div>
        ) : alertData ? (
          <AlertCard
            alertData={alertData}
            saving={saving}
          ...
          <div className="hospital-success-card">
        ...
        <div className="emergency-services">
          <div className="service-group">
            ...
            <div className="service-card">
              ...
              <span className="distance">Available</span>
            </div>

            <div className="service-card">
              <div>
                <strong>Ambulance Unit 02</strong>
                <p>011-2345679</p>
              </div>
              <span className="distance">Available</span>
            </div>
            ...
            <div className="service-card">
              <div>
                <strong>Ambulance Unit 03</strong>
                <p>011-2345680</p>
              </div>
              <span
                className="distance"
          ...
          <div className="service-group">
            ...
            <div className="service-card">
              <div>
                <strong>Malabe Police Station</strong>
                <p>011-2345678</p>
              </div>
